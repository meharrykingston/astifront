...
export const metadata: Metadata = {
  title: "Chronic Fatigue: Causes, Symptoms, and When to See a Doctor",
  description: "Struggling with constant exhaustion? Learn the common causes of chronic fatigue, how to identify underlying triggers, and when it’s time to consult a professional.",
  keywords: "chronic fatigue, extreme tiredness, exhaustion causes, fatigue symptoms, lethargy",
};
