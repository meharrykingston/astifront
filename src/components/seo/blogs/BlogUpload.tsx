    ...
    <div className="fixed inset-0 z-60 grid place-items-center bg-slate-900/45 p-4">
      <div className="w-full max-w-xl rounded-2xl border border-slate-200 bg-white p-5 shadow-2xl">
        ...
        >
          ...
          <p className="text-base font-semibold text-slate-900">{isUploading ? "Uploading..." : "Drag and drop JSON file here"}</p>
          <p className="mt-1 text-sm text-slate-600">or click to browse files</p>
        </label>
      </div>
    </div>
  );
